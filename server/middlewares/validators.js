...
const validateVisa = [
  ...
  // .isIn(['Egypt', 'Albania']).withMessage("Invalid destination"),

  body("otherCountries")
    .optional()
    .trim()
    .isLength({ max: 500 })
    .withMessage("Other countries text too long"),

  body("hasTraveledAbroad")
    .optional()
    .isBoolean()
    .withMessage("hasTraveledAbroad must be boolean"),

  body("visitedCountries")
    .optional()
    .trim()
    .isLength({ max: 1000 })
    .withMessage("Visited countries text too long"),
];

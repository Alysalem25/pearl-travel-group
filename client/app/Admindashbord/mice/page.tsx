                        ...
                        {isLoading ? (
                            ...
                            <div className="divide-y divide-slate-100">
                                {filteredMices.map((f: Mice) => (
                                    <div
                                        key={f._id}
                                        className={`p-6 hover:bg-slate-50/60 transition-all my-6 duration-200 border-2 border-slate-200 ${f.status === 'reviewed' ? 'bg-emerald-50/30' : 'bg-amber-50/20'
                                            }`}
                                    >
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center gap-2 flex-wrap">
                                                            <h3 className="text-lg font-bold text-slate-900">
                                                                {f.firstName + ' ' + f.lastName || 'Unnamed User'}
                                                            </h3>
                                                ...
                                                <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
                                                    ...
                                                    <p className="font-semibold text-slate-900">
                                                        <span className="text-slate-500 font-normal">
                                                            Job Function: {f.jobFunction}
                                                            <br />
                                                            Nationality: {f.nationality}
                                                            <br />
                                                            Organization: {f.organization}
                                                            <br />
                                                            Destination: {f.destination}</span>
                                                    </p>
                                                </div>
                                                        ...
                                                        {f.numOfGuests > 0 ? (
                                                            <>
                                                                ...
                                                                <span className="text-sm text-slate-500">
                                                                    {f.numOfGuests} Guest{f.numOfGuests !== 1 ? 's' : ''}
                                                                </span>
                                                            </>
                                                        ) : null}
                                                        {f.dateFrom && f.dateTo && (
                                                            <>
                                                                ...
                                                                <span className="text-sm text-slate-500">
                                                                    {new Date(f.dateFrom).toLocaleDateString()} - {new Date(f.dateTo).toLocaleDateString()}
                                                                </span>
                                                            </>
                                                        )
                                                        }

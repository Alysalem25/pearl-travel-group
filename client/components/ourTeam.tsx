...
//                                             animate={{
//                                                 boxShadow: isHovered
//                                                     ? '0 0 0 4px rgba(59, 130, 246, 0.2), 0 0 0 8px rgba(59, 130, 246, 0.1)'
...
//                                         {/* Decorative dots */}
//                                         <div className="absolute -top-2 -right-2 w-4 h-4 bg-blue-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
//                                         <div className="absolute -bottom-1 -left-3 w-3 h-3 bg-amber-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100" />
//                                     </div>
...
//                                             {member.name}
//                                         </h3>
//                                         <div className="w-8 h-0.5 bg-slate-200 mx-auto group-hover:w-16 group-hover:bg-blue-400 transition-all duration-500" />

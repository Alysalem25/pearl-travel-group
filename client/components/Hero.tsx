  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full -z-10 overflow-hidden">
        ...
        >
          <source src="https://res.cloudinary.com/dyissekq4/video/upload/q_auto/f_auto/v1776203058/Video_Project_1_v1rfsn.mp4" type="video/mp4" />
        </video>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24 lg:py-32">
        ...
        >
          ...
          <motion.h1
            ...
            className={`font-bold mb-6 sm:mb-8 leading-tight ${isRTL ? "font-arabic" : ""
              } ${
          ...
          <motion.p
            // variants={itemVariants}
            className={`mx-auto mb-8 sm:mb-12 leading-relaxed font-normal ${isRTL ? "font-arabic" : ""
              } ${
